...
const timelineAlerts = computed(() => {
  return alerts.value.slice(0, 6)
})

const tableItems = computed(() => alerts.value)

async function handleCategoryChange(value: AlertCategory | 'ALL') {
  await setAlertFilter({ category: value })
}

async function handleStatusChange(value: AlertStatus | 'ALL') {
  await setAlertFilter({ status: value })
}

async function handleScopeChange(value: 'CURRENT' | 'ALL') {
  await setAlertFilter({ personScope: value })
}
    ...
    <div class="filter-bar">
      <div class="pill-set">
        ...
        <button
          ...
          :key="item.value"
          :class="{ active: alertFilters.category === item.value }"
          type="button"
      ...
      <div class="pill-set">
        ...
        <button
          ...
          :key="item.value"
          :class="{ active: alertFilters.status === item.value }"
          type="button"
      ...
      <div class="pill-set">
        ...
        <button
          ...
          :key="item.value"
          :class="{ active: alertFilters.personScope === item.value }"
          type="button"
